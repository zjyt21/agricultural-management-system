...
import com.hlp.agrisys.filter.JwtAuthenticationTokenFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    //Create a BCryptPasswordEncoder and inject it into the container
    @Bean
